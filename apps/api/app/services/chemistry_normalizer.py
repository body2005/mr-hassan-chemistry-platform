...
CHEMISTRY_SYNONYM_MAP: dict[str, dict[str, Any]] = {
    ...
    "feo": {
        "formula": "FeO",
        "arabic_names": ["أكسيد الحديد الثنائي", "أكسيد الحديد (II)", "أكسيد الحديد (11)", "أكسيد الحديدوز", "أكسيد حديد ثنائي", "أكسيد حديد (II)", "أكسيد حديدوز", "أكسيد الحديد II"],
        "english_names": ["iron(II) oxide", "ferrous oxide"],
        "category": "oxide",
    },
    "fe2o3": {
        "formula": "Fe2O3",
        "arabic_names": ["أكسيد الحديد الثلاثي", "أكسيد الحديد (III)", "أكسيد الحديد (111)", "أكسيد الحديديك", "الهيماتيت", "أكسيد الحديد الاحمر"],
        "english_names": ["iron(III) oxide", "ferric oxide", "hematite"],
        "category": "oxide",
    },
    "fe3o4": {
        "formula": "Fe3O4",
        "arabic_names": ["أكسيد الحديد المغناطيسي", "الميجنتايت", "المغنتيت", "أكسيد الحديد الأسود", "المغناتيت"],
        "english_names": ["magnetic iron oxide", "iron(II,III) oxide", "magnetite"],
        "category": "oxide",
    },
    "fecl2": {
        "formula": "FeCl2",
        "arabic_names": ["كلوريد الحديد الثنائي", "كلوريد الحديد (II)", "كلوريد الحديد (11)", "كلوريد الحديدوز", "كلوريد حديدوز", "كلوريد الحديد II", "ملح كلوريد الحديد (II)"],
        "english_names": ["iron(II) chloride", "ferrous chloride"],
        "category": "salt",
    },
    "fecl3": {
        "formula": "FeCl3",
        "arabic_names": ["كلوريد الحديد الثلاثي", "كلوريد الحديد (III)", "كلوريد الحديد (111)", "كلوريد الحديديك", "كلوريد حديديك", "كلوريد الحديد III"],
        "english_names": ["iron(III) chloride", "ferric chloride"],
        "category": "salt",
    },
    "feso4": {
        "formula": "FeSO4",
        "arabic_names": ["كبريتات الحديد الثنائية", "كبريتات الحديد (II)", "كبريتات الحديدوز", "كبريتات حديدوز", "كبريتات الحديد II"],
        "english_names": ["iron(II) sulfate", "ferrous sulfate"],
        "category": "salt",
    },
    "fe(oh)2": {
        "formula": "Fe(OH)2",
        "arabic_names": ["هيدروكسيد الحديد الثنائي", "هيدروكسيد الحديد (II)", "هيدروكسيد الحديدوز", "هيدروكسيد حديدوز", "هيدروكسيد الحديد II"],
        "english_names": ["iron(II) hydroxide", "ferrous hydroxide"],
        "category": "base",
    },
    "fe(oh)3": {
        "formula": "Fe(OH)3",
        "arabic_names": ["هيدروكسيد الحديد الثلاثي", "هيدروكسيد الحديد (III)", "هيدروكسيد الحديديك", "هيدروكسيد حديديك", "هيدروكسيد الحديد III"],
