    ...
    lessons: [
      {
        ...
        content: `تنشأ الرابطة الأيونية بين فلز ولا فلز نتيجة التجاذب الكهربي الاستاتيكي، بينما تنشأ الرابطة التساهمية نتيجة المشاركة الإلكترونية بين ذرات اللافلزات. وتحدد نظرية تنافر أزواج الإلكترونات (VSEPR) الأشكال الفراغية للجزيئات.`
      }
    ]
  },
  {
